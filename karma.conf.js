module.exports = function (config)
{
	config.set({
        ...
        files: [
			...
			'app/bower_components/highcharts/modules/treemap.js',
			'app/bower_components/highcharts/modules/heatmap.js',
			'app/bower_components/highcharts-custom-events/js/customEvents.js',
			'app/bower_components/highcharts/modules/exporting.js',
			'app/bower_components/dom-to-image/dist/dom-to-image.min.js',
            {pattern: 'app/js/controllers/*.js', included: false},
            {pattern: 'app/js/services/*.js', included: false},
			{pattern: 'app/js/directives/*.js', included: false},
            {pattern: 'app/js/app.js', included: false},
            {pattern: 'app/js/routes.js', included: false},
